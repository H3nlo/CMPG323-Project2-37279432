...
namespace CMPG323_Project2_37279432.Controller
{
    [Route("api/[controller]")]
    [ApiController]
    public class OrderDetailsController : ControllerBase
    {
        private readonly Project2AZUREDBContext _context;

        public OrderDetailsController(Project2AZUREDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<OrderDetail>> PostOrderDetail(OrderDetail orderDetail)
        {
          if (_context.OrderDetails == null)
          {
              return Problem("Entity set 'Project2AZUREDBContext.OrderDetails'  is null.");
          }
